...
console.log(
  chalk.green(newTask.new),
  chalk.blueBright(" is added in your Todo - List successfully !!")
);
    ...
    let option = await inquirer.prompt([
      {
        ...
        message: chalk.yellowBright(
          "What you want to do in your Todo List? Select any one option: "
        ),
        choices: [
          "View List",
          "Add Task",
...
let deleteTask = async () => {
  ...
  console.log(
    chalk.redBright(deleteTask[0]),
    chalk.blueBright(": is deleted from your todo - list successfully!!!")
  );
};
let updateTask = async () => {
  ...
  console.log(
    chalk.redBright(taskforUpdate.update),
    chalk.blueBright(": is updated successfully in your Todo - List !!!")
  );
};
main();
